			...
			saveStockData : function(totalStocks) {
				...
				for (i=0; i<totalStocks.length; i++) {
					if (totalStocks[i].selected == true) {
						...
						selectedData = selectedData + {stockName:totalStocks[i].Name, stockSymbol:totalStocks[i].symbol, stockPrice:totalStocks[i].Open, stockQuantity:quantity} + ",";
						selectedDataArr.push({stockName:totalStocks[i].Name, stockSymbol:totalStocks[i].symbol, stockPrice:totalStocks[i].Open, stockQuantity:quantity});
					}
				}
